/*
  ...
  - The values [subscription_extended,trial_started,referral_bonus_added] on the enum `ActivityLogType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."ActivityLogType_new" AS ENUM ('purchased', 'trial_activated', 'bonus_claimed', 'referral_bonus_accrued');
